...
from myapi.common.paginator.pagination import paginated_data
...
class FetchServices(View):
    ...
    @staticmethod
    def all_instances_data(app_name, table_name, filter_query=None, order_query=None, page_size=None, page_number=None, fields=None):
        # Fetch table by app name and table name
        table = FindTables.get_table(
            app_name,
            table_name
        ...
        if not fields :
            ...
            filter_data = filter_data.value(*fields)
